...
use App\Http\Controllers\Data_KaryawanController;
...
|/users-profile /tables-data /forms-layouts /forms-editors /forms-validation /pages-login /pages-contact
 /pages-register /pages-blank
*/
